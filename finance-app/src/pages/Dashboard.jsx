...
export default class Dashboard extends Component {
  render() {
    return (
      <div className="bg-gray-50 pt-[20px] h-[100vh] -mt-[60px]">
        <div className="max-w-[90vw] mx-auto">
          <div className="mb-[20px] px-[30px] flex justify-between space-x-4 bg-white py-[20px] w-[265px] rounded shadow">
            <div className=" flex-1">
              <label htmlFor="year">Year</label>
              <br />
              <select
                className="border w-[70px] outline-none focus:outline-none"
                name="year"
                id="year"
              ></select>
            </div>
          ...
          <div>
            ...
            <div className="bg-white">
              <p className="text-center">Overall legend</p>
            </div>
          </div>
          ...
          <div className="px-[30px] mt-[20px]">
            ...
            <DataTable value={customers} lazy filterDisplay="row" dataKey="id" paginator
                    rows={10} totalRecords={customers.length}
